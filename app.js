...
// ---- This when using joe.Scope() refers to the object Student

// 2. What is "this" when joe.scopeArrow() is invoked?

// ---- This when using joe.scopeArrow() refers to the global window object

// 3. Explain why "this" is different when an arrow function is used.

// ---- The arrow function does not bind itself to the scope of an object and will refer to the global window when used
